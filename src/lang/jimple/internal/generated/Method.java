...
public abstract class Method extends JimpleAbstractDataType {
   @Override 
   ...
   public static Method method(List<Modifier> modifiers, Type returnType, String name, List<Type> formals, List<Type> exceptions, MethodBody body)  {
     return new c_method(modifiers, returnType, name, formals, exceptions, body);
   }
    

   
   public static class c_method extends Method {
     ...
     public c_method(List<Modifier> modifiers, Type returnType, String name, List<Type> formals, List<Type> exceptions, MethodBody body) {
