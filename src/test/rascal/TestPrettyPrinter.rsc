...
test bool testClassWithFields() {
	...
	//TODO: compare generated file with file generated by soot		
	writeFile(|file:///tmp/class6.jimple|, prettyPrint(x));		

	x = decompile(|project://JimpleFramework/target/test-classes/samples/LongValueSample.class|);
	//TODO: compare generated file with file generated by soot		
	writeFile(|file:///tmp/class7.jimple|, prettyPrint(x));		
		
	return true;
}

test bool testClassWithMethod() {
	x = decompile(|project://JimpleFramework/target/test-classes/slf4j/org/slf4j/helpers/SubstituteLoggerFactory.class|);
	//TODO: compare generated file with file generated by soot
	writeFile(|file:///tmp/class8.jimple|, prettyPrint(x));
	return true;
}
