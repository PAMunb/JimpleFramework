...
public class Method extends JimpleAbstractDataType {
	...
	public static Method method(List<Modifier> modifiers, Type returnType, String name, List<Type> formals,
			List<Type> exceptions, MethodBody body) {
		return new Method(modifiers, returnType, name, formals, exceptions, body);
	}

	public Method(List<Modifier> modifiers, Type returnType, String name, List<Type> formals, List<Type> exceptions,
			MethodBody body) {
