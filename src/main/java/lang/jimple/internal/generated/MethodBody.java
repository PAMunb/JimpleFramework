...
public abstract class MethodBody extends JimpleAbstractDataType {
	...
	public static MethodBody methodBody(List<LocalVariableDeclaration> localVariableDecls, List<Statement> stmts,
	...
	public static class c_methodBody extends MethodBody {
		...
		public c_methodBody(List<LocalVariableDeclaration> localVariableDecls, List<Statement> stmts,
				List<CatchClause> catchClauses) {
