...
public abstract class InvokeExp extends JimpleAbstractDataType {
	...
	public static InvokeExp dynamicInvoke(MethodSignature bsmSig, List<Immediate> bsmArgs, MethodSignature sig,
			List<Immediate> args) {
	...
	public static class c_dynamicInvoke extends InvokeExp {
		...
		public c_dynamicInvoke(MethodSignature bsmSig, List<Immediate> bsmArgs, MethodSignature sig,
				List<Immediate> args) {
