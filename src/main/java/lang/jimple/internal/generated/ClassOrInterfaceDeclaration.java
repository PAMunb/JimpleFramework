...
public abstract class ClassOrInterfaceDeclaration extends JimpleAbstractDataType {
	...
	public static ClassOrInterfaceDeclaration classDecl(Type typeName, List<Modifier> modifiers, Type superClass,
			List<Type> interfaces, List<Field> fields, List<Method> methods) {
		return new c_classDecl(typeName, modifiers, superClass, interfaces, fields, methods);
	}

	public static ClassOrInterfaceDeclaration interfaceDecl(Type typeName, List<Modifier> modifiers,
			List<Type> interfaces, List<Field> fields, List<Method> methods) {
	...
	public static class c_classDecl extends ClassOrInterfaceDeclaration {
		...
		public c_classDecl(Type typeName, List<Modifier> modifiers, Type superClass, List<Type> interfaces,
	...
	public static class c_interfaceDecl extends ClassOrInterfaceDeclaration {
		...
		public c_interfaceDecl(Type typeName, List<Modifier> modifiers, List<Type> interfaces, List<Field> fields,
				List<Method> methods) {
